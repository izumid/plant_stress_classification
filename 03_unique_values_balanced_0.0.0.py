...
def main():
	...
	config = read_config(os.path.join(os.getcwd(),"03_config_uvb"+".json"))
	list_window = new_window_size(total_sample_size=21888)
	sample_size = int(list_window[0][0] * list_window[0][1] / 6) #stimuli number (3) * classes: event & non event (2) = 6
...
if __name__ == "__main__":
	...
	new_window_size(total_sample_size=21888)
	#main()