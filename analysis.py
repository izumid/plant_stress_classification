...
def main():
	...
	column_select.remove("valid_window")
	...
	data_analysis.valid_window_tag(path_absolute_origin=path_valid_window,path_absolute_destination=os.path.join(path_analyses,"03_valid_window.feather"))
	...
	data_analysis.chart_experiment_behaviour(path_origin_absolute=path_melted,path_destination=path_image,new_label_name=new_label_name)
